...
public static class GameSettings
{
    ...
    {
        new CameraPosition("Near Cam", new Vector3(0, 0.4f, -2.75f), false, 20f),
        new CameraPosition("Far Cam", new Vector3(0, 0.75f, -3.5f), false, 22f),
        new CameraPosition("Hood Cam", new Vector3(0,0.6f,0.2f -0.25f), true, 2.5f),
        new CameraPosition("Low Cam", new Vector3(0, 0.3f, -2.25f), false, 18f)
    };
